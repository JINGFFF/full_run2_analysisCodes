...
void smallTree::use_f(TString type){
   if(type = "fp"){
      PHOTONET      = photonet_f;
      PHOTONETA     = photoneta_f;
      PHOTONPHI     = photonphi_f;
      PHOTONSCETA   = photonsceta_f;

      JET1ETA       = jet1eta_new_f;
      JET2ETA       = jet2eta_new_f;
      JET1PT        = jet1pt_new_f;
      JET2PT        = jet2pt_new_f;
      JET1PF        = jet1pf_f;
      JET2PF        = jet2pf_f;
      JET1ICSV      = jet1icsv_new_f;
      JET2ICSV      = jet2icsv_new_f;
      ...
      JET1PF        = jet1pf;
      JET2PF        = jet2pf;
      JET1ICSV      = jet1icsv_new;
      JET2ICSV      = jet2icsv_new;
